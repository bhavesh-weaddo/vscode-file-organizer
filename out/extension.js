...
function activate(context) {
    ...
    let organizeCommand = vscode.commands.registerCommand('vscode-file-organizer.organize', async (uri) => {
    ...
    let statsCommand = vscode.commands.registerCommand('vscode-file-organizer.showStats', async (uri) => {
        const folderPath = uri ? uri.fsPath : vscode.workspace.workspaceFolders?.[0].uri.fsPath;
        if (!folderPath) {
